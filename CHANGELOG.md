...
All notable changes to the MEP Lab AI agent desktop app will be documented in this file.
...
- Updated MEP Lab app icons for Windows and macOS packaging (branding refresh)
...
- Initial release of MEP Lab — open-source AI agent desktop app with one-click install for Windows and macOS

[Unreleased]: https://github.com/days201/MEP-lab/compare/v3.3.0-beta.8...HEAD
[3.3.0-beta.8]: https://github.com/days201/MEP-lab/compare/v3.2.0...v3.3.0-beta.8
[3.2.0]: https://github.com/days201/MEP-lab/compare/v3.1.0...v3.2.0
[3.1.0]: https://github.com/days201/MEP-lab/compare/v3.0.0...v3.1.0
[3.0.0]: https://github.com/days201/MEP-lab/compare/v2.0.0...v3.0.0
[2.0.0]: https://github.com/days201/MEP-lab/compare/v1.0...v2.0.0
[1.0.0]: https://github.com/days201/MEP-lab/releases/tag/v1.0
